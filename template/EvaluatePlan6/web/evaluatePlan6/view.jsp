	...
	<form:form id="evaluatePlan6Form" modelAttribute="evaluatePlan6Form" class="form-horizontal">	
		...
		<fieldset>
			...
			<div class="form-group-add row">
				...
				<div class="col-md-2">
					<input class="form-control" placeholder="" name="" id="dept_id1View" type="text" readonly="true"/>
				</div>
				<label class="col-md-1 control-label ">Đơn vị khác</label>
				<div class="col-md-2">
					<input class="form-control" placeholder="" name="" id="dept_other1View" type="text" readonly="true"/>
				</div>
				<label class="col-md-1 control-label ">Các căn cứ</label>
				<div class="col-md-2">
					<input class="form-control" placeholder="" name="" id="the_bases1View" type="text" readonly="true"/>
				</div>
				<label class="col-md-1 control-label ">Mục đích, yêu cầu</label>
				<div class="col-md-2">
					<input class="form-control" placeholder="" name="" id="the_purpose1View" type="text" readonly="true"/>
				</div>
			</div>
			...
			<div class="form-group-add row">
				...
				<div class="col-md-2">
					<input class="form-control" placeholder="" name="" id="place_and_time1View" type="text" readonly="true"/>
				</div>
			...
			<div class="form-group-add row">
				...
				<div class="col-md-2">
					<input class="form-control" placeholder="" name="" id="fileView" type="text" readonly="true"/>
				</div>
			</div>
